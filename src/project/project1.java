...
public class project1 {
    ...
    /**
     * a room with tiles tables, and mirrors
     */
    @Test
    public void projectTest1() {
        Camera camera = new Camera(new Point3D(2000, 2000, 1100), new Vector(0, 0, -1), new Vector(0, 1, 0))
                .turnAngle(new Point3D(0,0,10),0)//
        ...
        scene.geometries.add( //
                new Plane(new Point3D(0, 0, 0), new Vector(0, 1, 0)) // wall
                        .setEmission(new Color(103, 106, 127))
                ...
                new Polygon(new Point3D(1,100,50),new Point3D(1,300,50),//large clear mirror
                ...
                new Polygon(new Point3D(100,1,100),new Point3D(150,1,100),//glossy mirror
            ...
            for (j=0; j<500;j+=INTERVAL_BETWEEN_TABLE) {
                ...
                scene.geometries.add(
                        ...
                        new Polygon (p1,p8,p7,p2)//table surface
                                ...
                                .setMaterial(new Material().setKd(0.8).setKs(0.2).setShininess(30).setKt(0)),
                        ...
                        new Polygon (p11,p6,p7,p10)//table surface
                                .setEmission(new Color(50, 10, 10)) //
                                .setMaterial(new Material().setKd(0.8).setKs(0.2).setShininess(30).setKt(0)),
                        new Polygon (p9,p10,p11,p12)//table blurry surface
                                .setEmission(new Color(50, 10, 10)) //
                                .setMaterial(new Material().setKd(0.2).setKs(0.8).setShininess(30).setKt(0.7).setkB(0.6)));
